    ...
    >
      ...
      <l-control position="bottomright"
        ><v-card style="padding: 1rem" color="#CFD8DC">
          ...
          ><span style="margin-left: 1em">{{Math.round(this.levelColor.a20)}}</span><br />
          <i style="background: #d2f6c5">&emsp;</i
          ><span style="margin-left: 1em">{{Math.round(this.levelColor.a40)}}</span><br />
          <i style="background: #99f3bd">&emsp;</i
          ><span style="margin-left: 1em">{{Math.round(this.levelColor.a60)}}</span><br />
          <i style="background: #28df99">&emsp;</i
          ><span style="margin-left: 1em">{{Math.round(this.levelColor.a80)}}</span><br />
          <i style="background: #2ec1ac">&emsp;</i
          ><span style="margin-left: 1em">{{Math.round(this.levelColor.a100)}}</span></v-card
        ></l-control
      >
      <!-- <l-polygon
